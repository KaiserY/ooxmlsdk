...
221 matrix rows are covered by active PPTX PDF tests. They currently span
LibreOffice import text/color/fill/line/border/page assertions and layout
metafile-position assertions.
`layout-tests.cxx::numberedList` keeps the LibreOffice text-order expectation
unchanged.
...
| `import-tests.cxx::testTdf154363` | `pptx/tdf154363.pptx` | `../core/sd/qa/unit/import-tests.cxx:339` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf154858` | `pptx/tdf154858.pptx` | `../core/sd/qa/unit/import-tests.cxx:363` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf153466` | `pptx/tdf153466.pptx` | `../core/sd/qa/unit/import-tests.cxx:372` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf152434` | `pptx/tdf152434.pptx` | `../core/sd/qa/unit/import-tests.cxx:391` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testConnectors` | `pptx/connectors.pptx` | `../core/sd/qa/unit/import-tests.cxx:402` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf153036_resizedConnectorL` | `pptx/tdf153036_resizedConnectorL.pptx` | `../core/sd/qa/unit/import-tests.cxx:426` | `covered` | partial visible-output assertion. |
...
| `import-tests.cxx::testTdf149314` | `pptx/tdf149314.pptx` | `../core/sd/qa/unit/import-tests.cxx:453` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf149124` | `pptx/tdf149124.pptx` | `../core/sd/qa/unit/import-tests.cxx:479` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf148965` | `pptx/tdf148965.pptx` | `../core/sd/qa/unit/import-tests.cxx:496` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf89449` | `pptx/tdf89449.pptx` | `../core/sd/qa/unit/import-tests.cxx:529` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testGluePointLeavingDirections` | `pptx/glue_point_leaving_directions.pptx` | `../core/sd/qa/unit/import-tests.cxx:564` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf147459` | `pptx/tdf147459.pptx` | `../core/sd/qa/unit/import-tests.cxx:592` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf146223` | `pptx/tdf146223.pptx` | `../core/sd/qa/unit/import-tests.cxx:621` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf144918` | `pptx/tdf144918.pptx` | `../core/sd/qa/unit/import-tests.cxx:635` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf144917` | `pptx/tdf144917.pptx` | `../core/sd/qa/unit/import-tests.cxx:658` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testHyperlinkOnImage` | `pptx/hyperlinkOnImage.pptx` | `../core/sd/qa/unit/import-tests.cxx:674` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf142645` | `pptx/tdf142645.pptx` | `../core/sd/qa/unit/import-tests.cxx:699` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf141704` | `pptx/tdf141704.pptx` | `../core/sd/qa/unit/import-tests.cxx:709` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf142915` | `pptx/tdf142915.pptx` | `../core/sd/qa/unit/import-tests.cxx:764` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf142913` | `pptx/tdf142913.pptx` | `../core/sd/qa/unit/import-tests.cxx:778` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testTdf142590` | `pptx/tdf142590.pptx` | `../core/sd/qa/unit/import-tests.cxx:792` | `covered` | partial visible-output assertion. |
| `import-tests.cxx::testCustomSlideShow` | `pptx/tdf131390.pptx` | `../core/sd/qa/unit/import-tests.cxx:806` | `covered` | partial visible-output assertion. |
...
| `import-tests2.cxx::testTdf79007` | `pptx/tdf79007.pptx` | `../core/sd/qa/unit/import-tests2.cxx:454` | `covered` | partial visible-output assertion. |
...
| `import-tests2.cxx::testTdf118776` | `pptx/tdf118776.pptx` | `../core/sd/qa/unit/import-tests2.cxx:545` | `covered` | partial visible-output assertion. |
| `import-tests2.cxx::testTdf129686` | `pptx/tdf129686.pptx` | `../core/sd/qa/unit/import-tests2.cxx:563` | `covered` | partial visible-output assertion. |
...
| `import-tests2.cxx::testTdf105150` | `pptx/tdf105150.pptx` | `../core/sd/qa/unit/import-tests2.cxx:713` | `covered` | partial visible-output assertion. |
| `import-tests2.cxx::testTdf123684` | `pptx/tdf123684.pptx` | `../core/sd/qa/unit/import-tests2.cxx:726` | `covered` | partial visible-output assertion. |
...
| `import-tests2.cxx::testTdf89064` | `pptx/tdf89064.pptx` | `../core/sd/qa/unit/import-tests2.cxx:1045` | `covered` | partial visible-output assertion. |
...
| `import-tests2.cxx::testTdf115394` | `pptx/tdf115394.pptx` | `../core/sd/qa/unit/import-tests2.cxx:1324` | `covered` | partial visible-output assertion. |
...
| `import-tests3.cxx::testCreationDate` | `fdo71434.pptx` | `../core/sd/qa/unit/import-tests3.cxx:394` | `covered` | partial visible-output assertion. |
...
| `import-tests3.cxx::testTableBorderLineStyle` | `pptx/tableBorderLineStyle.pptx` | `../core/sd/qa/unit/import-tests3.cxx:670` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testTableMergedCellsBorderLineStyle` | `pptx/tdf149865.pptx` | `../core/sd/qa/unit/import-tests3.cxx:707` | `covered` | partial visible-output assertion. |
...
| `import-tests3.cxx::testBnc862510_7` | `pptx/bnc862510_7.pptx` | `../core/sd/qa/unit/import-tests3.cxx:749` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testBulletSuffix` | `pptx/n83889.pptx` | `../core/sd/qa/unit/import-tests3.cxx:892` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testBnc910045` | `pptx/bnc910045.pptx` | `../core/sd/qa/unit/import-tests3.cxx:907` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testRowHeight_n80340` | `pptx/n80340.pptx` | `../core/sd/qa/unit/import-tests3.cxx:925` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testRowHeight_tableScale` | `pptx/tablescale.pptx` | `../core/sd/qa/unit/import-tests3.cxx:941` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testTdf93830` | `pptx/tdf93830.pptx` | `../core/sd/qa/unit/import-tests3.cxx:962` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testTdf165732` | `pptx/tdf165732.pptx` | `../core/sd/qa/unit/import-tests3.cxx:979` | `covered` | partial visible-output assertion. |
...
| `import-tests3.cxx::testTdf93097` | `pptx/tdf93097.pptx` | `../core/sd/qa/unit/import-tests3.cxx:1025` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testTdf62255` | `pptx/tdf62255.pptx` | `../core/sd/qa/unit/import-tests3.cxx:1037` | `covered` | partial visible-output assertion. |
...
| `import-tests3.cxx::testTdf152070` | `pptx/tdf152070.pptx` | `../core/sd/qa/unit/import-tests3.cxx:1114` | `covered` | partial visible-output assertion. |
| `import-tests3.cxx::testTdf111927` | `pptx/tdf163239.pptx` | `../core/sd/qa/unit/import-tests3.cxx:1143` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testTdf51340` | `pptx/tdf51340.pptx` | `../core/sd/qa/unit/import-tests4.cxx:61` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testTdf149206` | `pptx/tdf149206.pptx` | `../core/sd/qa/unit/import-tests4.cxx:164` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testtdf163852` | `pptx/tdf163852.pptx` | `../core/sd/qa/unit/import-tests4.cxx:183` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testTdf149785` | `pptx/tdf149785.pptx` | `../core/sd/qa/unit/import-tests4.cxx:198` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testTdf149985` | `pptx/tdf149985.pptx` | `../core/sd/qa/unit/import-tests4.cxx:207` | `covered` | partial visible-output assertion. |
...
| `import-tests4.cxx::testTdf120028` | `pptx/tdf120028.pptx` | `../core/sd/qa/unit/import-tests4.cxx:236` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testDescriptionImport` | `pptx/altdescription.pptx` | `../core/sd/qa/unit/import-tests4.cxx:267` | `covered` | partial tagged-PDF/accessibility assertion. |
| `import-tests4.cxx::testTdf47365` | `pptx/loopNoPause.pptx` | `../core/sd/qa/unit/import-tests4.cxx:318` | `covered` | partial slideshow-state assertion; do not turn into a full PDF export test. |
| `import-tests4.cxx::testOOXTheme` | `pptx/ooxtheme.pptx` | `../core/sd/qa/unit/import-tests4.cxx:358` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testCropToShape` | `pptx/crop-to-shape.pptx` | `../core/sd/qa/unit/import-tests4.cxx:380` | `covered` | partial visible-output assertion. |
| `import-tests4.cxx::testTdf127964` | `pptx/tdf127964.pptx` | `../core/sd/qa/unit/import-tests4.cxx:401` | `covered` | partial visible-output assertion. |
...
| `import-tests4.cxx::testTdf103347` | `pptx/tdf103347.pptx` | `../core/sd/qa/unit/import-tests4.cxx:591` | `covered` | partial visible-output assertion. |
...
| `import-tests-smartart.cxx::testCnt` | `pptx/smartart-cnt.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:192` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testDir` | `pptx/smartart-dir.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:207` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testTdf148665` | `pptx/tdf148665.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:218` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testTdf148921` | `pptx/tdf148921.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:233` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testMaxDepth` | `pptx/smartart-maxdepth.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:255` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testRotation` | `pptx/smartart-rotation.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:272` | `covered` | partial visible-output assertion. |
| `import-tests-smartart.cxx::testTextAutoRotation` | `pptx/smartart-autoTxRot.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:290` | `covered` | partial visible-output assertion. |
...
| `import-tests-smartart.cxx::testInteropGrabBag` | `pptx/smartart-interopgrabbag.pptx` | `../core/sd/qa/unit/import-tests-smartart.cxx:1010` | `covered` | partial visible-output assertion. |
...
| `layout-tests.cxx::numberedList` | `pptx/NumberedList-12ab-ab-34.pptx` | `../core/sd/qa/unit/layout-tests.cxx:273` | `covered` | partial metafile/PDF primitive assertion. |
...
| `PNGExportTests.cxx::testTdf156808` | `pptx/tdf156808.pptx` | `../core/sd/qa/unit/PNGExportTests.cxx:250` | `covered` | full page raster assertion. |
| `PNGExportTests.cxx::testTdf157793` | `pptx/tdf157793.pptx` | `../core/sd/qa/unit/PNGExportTests.cxx:503` | `covered` | full page raster assertion. |
| `PNGExportTests.cxx::testTdf157635` | `pptx/tdf157635.pptx` | `../core/sd/qa/unit/PNGExportTests.cxx:553` | `covered` | full page raster assertion. |
| `PNGExportTests.cxx::testTdf113163` | `pptx/tdf113163.pptx` | `../core/sd/qa/unit/PNGExportTests.cxx:603` | `covered` | full page raster assertion. |
| `ThemeTest.cxx::testThemeChange` | `theme.pptx` | `../core/sd/qa/unit/ThemeTest.cxx:65` | `covered` | full theme-render assertion. |
| `ShapeImportExportTest.cxx::testTextDistancesOOXML` | `TextDistancesInsets1.pptx` | `../core/sd/qa/unit/ShapeImportExportTest.cxx:58` | `covered` | partial text-inset geometry assertion. |
| `ShapeImportExportTest.cxx::testTextDistancesOOXML_LargerThanTextAreaSpecialCase` | `TextDistancesInsets2.pptx` | `../core/sd/qa/unit/ShapeImportExportTest.cxx:167` | `covered` | partial text-inset geometry assertion. |
| `FontEmbeddingTest.cxx::testRoundtripEmbeddedFontsPPTX` | `BoldonseFontEmbedded.pptx` | `../core/sd/qa/unit/FontEmbeddingTest.cxx:34` | `covered` | full font/PDF-resource assertion. |
| `FontEmbeddingTest.cxx::testTdf167214` | `pptx/tdf167214.pptx` | `../core/sd/qa/unit/FontEmbeddingTest.cxx:137` | `covered` | full font/PDF-resource assertion. |
...
| Upstream test | Fixture | Source file | Status | PDF projection |
|---|---|---|---|---|
| `ScFiltersTest2::testTdf123026_optimalRowHeight` | `xlsx/tdf123026_optimalRowHeight.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:153` | `covered` | Project optimal imported row height to PDF text bounds: wrapped/multiline text must fit inside the row and remain visible. |
| `ScFiltersTest2::testTdf159581_optimalRowHeight` | `xlsx/tdf159581_optimalRowHeight.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:164` | `covered` | Project imported optimal row height to PDF row geometry: the first row on sheet 2 should not be over-expanded. |
| `ScExportTest4::testTdf144642_RowHeightRounding_saveByCalc` | `xlsx/tdf144642_RowHeight_10mm_SavedByCalc.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:982` | `covered` | Project Calc-saved 10 mm row-height preservation to PDF grid/text vertical positions. |
| `ScExportTest4::testTdf144642_RowHeightRounding_saveByExcel` | `xlsx/tdf144642_RowHeight_28.35pt_SavedByExcel.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:991` | `covered` | Project Excel-saved 27.75 pt rounded row height to PDF grid/text vertical positions. |
| `ScExportTest4::testTdf145129_DefaultRowHeightRounding` | `xlsx/tdf145129_DefaultRowHeight_28.35pt_SavedByExcel.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:1002` | `covered` | Project Excel default row-height rounding to PDF page count and visible row numbers. |
| `ScExportTest::testMiscRowHeightExport` | `xlsx/miscrowheights.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:1141` | `covered` | Project distributed explicit/default row heights to PDF row positions and visible text order. |
...
| `ScExportTest4::testTdf123139XLSX` | `xlsx/tdf123139_applyAlignment.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:568` | `covered` | Project `applyAlignment` inheritance to PDF text placement and visible alignment/distribution sample text. |
| `ScExportTest5::testTdf130104_XLSXIndent` | `xlsx/tdf130104_indent.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:359` | `covered` | Project imported indentation levels to visible PDF text positions. |
| `ScExportTest3::testPreserveTextWhitespaceXLSX` | `xlsx/preserve-whitespace.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1543` | `covered` | Project preserved shared-string whitespace to visible PDF cell text. |
| `ScExportTest3::testPreserveTextWhitespace2XLSX` | `xlsx/preserve_space.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1553` | `covered` | Project preserved spaces and non-wrapped single-line row height to visible PDF text. |
| `ScFiltersTest4::testEscapedUnicodeXLSX` | `xlsx/escape-unicode.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1184` | `covered` | Project escaped Unicode newline import to PDF text without literal `_x000D_`. |
| `ScFiltersTest2::testSingleLine_xlsx` | `xlsx/cell-multi-line.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1704` | `covered` | Project single-paragraph and multi-paragraph edit text to visible PDF lines. |
| `ScFiltersTest::testBooleanFormatXLSX` | `xlsx/check-boolean.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:401` | `covered` | Project imported boolean number format to rendered `TRUE` cell strings. |
| `ScFiltersTest::testCellValueXLSX` | `xlsx/cell-value.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:1596` | `covered` | Project imported numeric/string cell values to visible PDF text across pages. |
| `ScExportTest5::testSecondsWithoutTruncateAndDecimals` | `xlsx/seconds-without-truncate-and-decimals.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:577` | `covered` | Project `[SS].00` number format to rendered PDF text with seconds and decimals preserved. |
| `ScExportTest5::testEmbeddedTextInDecimal` | `xlsx/embedded-text-in-decimal.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:623` | `covered` | Project embedded literal text in decimal number format to PDF cell text. |
| `ScExportTest::testCellBordersXLSX` | `xlsx/cell-borders.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:2272` | `covered` | Project imported cell borders to PDF path count, stroke colors, and bounds. |
| `ScExportTest3::testFontSizeXLSX` | `xlsx/fontSize.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1452` | `covered` | Project 18 pt textbox run size to PDF text size and visible text. |
| `ScExportTest3::testSheetRunParagraphPropertyXLSX` | `xlsx/TextColor.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1531` | `covered` | Project rich-text color to PDF text fill color and visible text. |
| `ScExportTest3::testTextUnderlineColorXLSX` | `xlsx/underlineColor.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1499` | `covered` | Project underlined textbox runs to visible PDF textbox labels. |
| `ScFiltersTest2::testEditEngStrikeThroughXLSX` | `xlsx/strike-through.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:828` | `covered` | Project rich edit text content with strike-through run to visible PDF text. |
| `ScExportTest4::testHeaderFontStyleXLSX` | `xlsx/tdf134826.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:484` | `covered` | Project imported header font style runs to visible PDF header text. |
...
| `CondFormatTest::testColorScaleXLSX` | `xlsx/colorscale.xlsx` | `../core/sc/qa/unit/cond_format.cxx:603` | `covered` | Project imported color-scale worksheet values to PDF pages while keeping color-scale paint work open for raster/path assertions. |
| `CondFormatTest::testDataBarXLSX` | `xlsx/databar.xlsx` | `../core/sc/qa/unit/cond_format.cxx:585` | `covered` | Project imported data-bar worksheet values to PDF pages while keeping bar geometry/fill-color paint work open for raster/path assertions. |
...
| `CondFormatTest::testComplexIconSetsXLSX` | `xlsx/complex_icon_set.xlsx` | `../core/sc/qa/unit/cond_format.cxx:676` | `covered` | Project imported icon-set worksheet values to PDF pages while keeping icon paint details open for raster/path assertions. |
| `CondFormatTest::testNewCondFormatXLSX` | `xlsx/new_cond_format_test.xlsx` | `../core/sc/qa/unit/cond_format.cxx:824` | `covered` | Project upstream conditional-format CSV expectation table to visible PDF text across pages. |
| `CondFormatTest::testTdf167019` | `xlsx/tdf167019.xlsx` | `../core/sc/qa/unit/cond_format.cxx:271` | `covered` | Project conditional-format range fixture to visible PDF table text and measured pressure rows. |
...
| `ScExportTest2::testTdf166724_cellAnchor` | `xlsx/tdf166724_cellAnchor.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:89` | `covered` | Project cell-anchored control position to PDF object bounds derived from row/column metrics. |
| `ScExportTest2::testTdf91634XLSX` | `xlsx/image_hyperlink.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1208` | `covered` | Project image hyperlink to visible image object and PDF link annotation target. |
| `ScExportTest3::testHiddenShapeXLSX` | `xlsx/hiddenShape.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1589` | `covered` | Project hidden shape state to PDF object absence while visible shapes remain. |
| `ScExportTest4::testtdf169496_hidden_graphic` | `xlsx/tdf169496_hidden_graphic.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:939` | `covered` | Project hidden picture state to PDF image absence/presence by graphic name order. |
| `ScExportTest4::testCheckboxFormControlXlsxExport` | `xlsx/checkbox-form-control.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:1046` | `covered` | Project checkbox form-control import to visible PDF checkbox label. |
| `ScFiltersTest4::testControlImport` | `xlsx/singlecontrol.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:107` | `covered` | Project form-control workbook sheets to visible PDF sheet text. |
| `ScFiltersTest4::testActiveXOptionButtonGroup` | `xlsx/tdf111980_radioButtons.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:191` | `covered` | Project ActiveX/form option button grouping to visible PDF button labels. |
| `ScExportTest3::testShapeAutofitXLSX` | `xlsx/testShapeAutofit.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1608` | `covered` | Project DrawingML autofit import to visible PDF shape text for both autofit and no-autofit shapes. |
| `ScFiltersTest3::testTdf83671_SmartArt_import` | `xlsx/tdf83671_SmartArt_import.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1475` | `covered` | Project SmartArt group import to visible PDF diagram text. |
| `ScFiltersTest3::testTdf151818_SmartArtFontColor` | `xlsx/tdf151818_SmartartThemeFontColor.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1544` | `covered` | Project SmartArt theme font-color import to visible PDF shape text. |
| `SparklineImportExportTest::testSparklinesRoundtripXLSX` | `xlsx/Sparklines.xlsx` | `../core/sc/qa/unit/SparklineImportExportTest.cxx:149` | `covered` | Project imported sparkline workbook source values to visible PDF pages while keeping sparkline line paint open for raster/path assertions. |
| `ScExportTest4::testTdf136721_paper_size` | `xlsx/tdf136721_letter_sized_paper.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:914` | `covered` | Project imported paper size to PDF page dimensions. |
| `ScFiltersTest::testHyperlinksXLSX` | `xlsx/hyperlinks.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:635` | `covered` | Project cell hyperlinks to PDF link annotations and visible linked text. |
| `ScFiltersTest2::testHiddenSheetsXLSX` | `xlsx/hidden_sheets.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1008` | `covered` | Project hidden sheet visibility to printed output containing only visible sheet text. |
| `ScExportTest4::testTdf121715_FirstPageHeaderFooterXLSX` | `xlsx/tdf121715.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:390` | `covered` | Project first/even page header/footer import to PDF header/footer text on pages 1 and 2. |
| `ScExportTest4::testTdf134459_HeaderFooterColorXLSX` | `xlsx/tdf134459_HeaderFooterColor.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:435` | `covered` | Project header/footer sections and colors to visible PDF header/footer text. |
| `ScExportTest4::testTdf134817_HeaderFooterTextWith2SectionXLSX` | `xlsx/tdf134817_HeaderFooterTextWith2Section.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:450` | `covered` | Project multi-section header/footer text to visible PDF text. |
| `ScExportTest2::testTextDirectionXLSX` | `xlsx/writingMode.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:315` | `covered` | Project imported text direction samples to visible PDF text. |
| `ScExportTest3::testHyperlinkXLSX` | `xlsx/hyperlink.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1622` | `covered` | Project drawing hyperlink relationship to PDF link annotation target. |
| `ScExportTest3::testSheetTextBoxHyperlinkXLSX` | `xlsx/textbox-hyperlink.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1438` | `covered` | Project textbox hyperlink to visible textbox text and PDF link annotation. |
| `ScExportTest2::testTdf123645XLSX` | `xlsx/chart_hyperlink.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1477` | `covered` | Project chart hyperlink relationships to visible chart output and PDF link targets. |
| `ScFiltersTest5::testTableStyleXLSX` | `xlsx/TableStyleTest.xlsx` | `../core/sc/qa/unit/subsequent_filters_test5.cxx:332` | `covered` | Project imported table style and totals row to visible PDF table text. |
| `ScExportTest5::testTotalsRowFunction` | `xlsx/totalsRowFunction.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:647` | `covered` | Project totals-row function import to visible PDF total value. |
| `ScExportTest5::testTotalsRowShown` | `xlsx/totalsRowShown.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:670` | `covered` | Project table total-row visibility flag to visible PDF table rows. |
| `ScExportTest5::testAutofilterHiddenButton` | `xlsx/hiddenButton.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:729` | `covered` | Project hidden autofilter buttons to visible PDF header row. |
| `ScExportTest5::testAutofilterShowButton` | `xlsx/autofilterShowButton.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:743` | `covered` | Project autofilter show-button column import to visible filtered columns. |
| `ScExportTest2::testDateAutofilterXLSX` | `xlsx/dateAutofilter.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:570` | `covered` | Project date autofilter import to visible PDF filtered date rows. |
| `ScExportTest2::testAutofilterColorsOOXML` | `xlsx/autofilter-colors.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:649` | `covered` | Project color-filter import to visible PDF filtered background-color rows. |
| `ScExportTest2::testAutofilterColorsOOXML2` | `xlsx/autofilter-colors-fg.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:666` | `covered` | Project foreground-color filter import to visible PDF filtered rows. |
| `ScFiltersTest2::testTdf153767` | `xlsx/tdf153767.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:248` | `covered` | Project imported boolean text values to visible PDF strings. |
| `ScFiltersTest2::testTdf161301` | `xlsx/tdf161301.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:261` | `covered` | Project imported Japanese era date strings to visible PDF text. |
| `ScPivotTableFiltersTest::testPivotCacheExportXLSX` | `xlsx/pivot-table/with-strings-integers-and-dates.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:630` | `covered` | Project mixed string/integer/date pivot cache import to visible PDF pivot totals and source rows. |
| `ScPivotTableFiltersTest::testPivotTableTwoDataFields` | `xlsx/pivot-table/two-data-fields.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1109` | `covered` | Project two visible data fields to PDF pivot headers and total results. |
| `ScPivotTableFiltersTest::testPivotTableCompactLayoutXLSX` | `xlsx/pivot-table/pivotcompact.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2553` | `covered` | Project compact pivot row/column fields to visible PDF nested labels and totals. |
| `ScPivotTableFiltersTest::testFirstHeaderRowZero` | `xlsx/pivot-table/first_header_row_zero.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2638` | `covered` | Project first-header-row-zero import to visible pivot table and the following `under` cell. |
| `ScPivotTableFiltersTest::testCalcFields1XLSX` | `xlsx/pivot-table/calcfields.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2704` | `covered` | Project calculated pivot fields to visible PDF pivot totals. |
| `ScPivotTableFiltersTest::testCalcFields2XLSX` | `xlsx/pivot-table/onlycalcfields.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2808` | `covered` | Project calculated-only pivot field output to visible PDF pages. |
| `ScPivotTableFiltersTest::testGroupAndCalcFieldXLSX` | `xlsx/pivot-table/groupwithcalcfields.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2834` | `covered` | Project grouped calculated fields to visible PDF group totals. |
| `ScPivotTableFiltersTest::testCalcFieldSingleDataDimXLSX` | `xlsx/pivot-table/tdf126858-1.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:3005` | `covered` | Project single calculated-field pivot import to visible PDF source/pivot text. |
| `ScPivotTableFiltersTest::testCalcFieldDiffAggregationXLSX` | `xlsx/pivot-table/test_diff_aggregation.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:3027` | `covered` | Project SUM and COUNT pivot outputs to visible PDF pages. |
| `ScPivotTableFiltersTest::testPivotTableDoubleFieldFilterXLSX` | `xlsx/pivottable_double_field_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1734` | `covered` | Project numeric formatted pivot member filtering to visible PDF rows/totals. |
| `ScPivotTableFiltersTest::testPivotTableStringFieldFilterXLSX` | `xlsx/pivottable_string_field_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1832` | `covered` | Project string pivot member filtering to visible PDF rows where filtered-out members are absent. |
| `ScPivotTableFiltersTest::testPivotTableDateFieldFilterXLSX` | `xlsx/pivottable_date_field_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1864` | `covered` | Project date pivot member filtering to visible PDF date rows. |
| `ScPivotTableFiltersTest::testPivotTableSharedGroupXLSX` | `xlsx/pivot-table/shared-group-field.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:326` | `covered` | Project shared pivot group fields to visible PDF group labels and totals. |
| `ScPivotTableFiltersTest::testPivotTableSharedDateGroupXLSX` | `xlsx/pivot-table/shared-dategroup.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:394` | `covered` | Project shared date grouping to visible PDF year labels and grouped totals. |
| `ScPivotTableFiltersTest::testPivotTableSharedNestedDateGroupXLSX` | `xlsx/pivot-table/shared-nested-dategroup.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:437` | `covered` | Project nested year/quarter/month date grouping to visible PDF pivot labels and totals. |
| `ScPivotTableFiltersTest::testPivotTableSharedNumGroupXLSX` | `xlsx/pivot-table/shared-numgroup.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:446` | `covered` | Project shared number grouping to visible PDF range labels and totals. |
| `ScPivotTableFiltersTest::testPivotTableBoolFieldFilterXLSX` | `xlsx/pivottable_bool_field_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1936` | `covered` | Project boolean pivot member filtering to visible PDF output where `TRUE` is included and `FALSE` is excluded from the pivot. |
| `ScPivotTableFiltersTest::testPivotTableRowColPageFieldFilterXLSX` | `xlsx/pivottable_rowcolpage_field_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:1969` | `covered` | Project row/column/page pivot member filtering to visible PDF row fields and page-field labels. |
| `ScPivotTableFiltersTest::testPivotTableErrorItemFilterXLSX` | `xlsx/pivottable_error_item_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2073` | `covered` | Project pivot error-item filtering to visible PDF source/pivot rows including `#DIV/0!`. |
| `ScPivotTableFiltersTest::testTdf125046` | `xlsx/pivottable_long_text.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2416` | `covered` | Project long pivot cache text import to visible PDF long text rows. |
| `ScPivotTableFiltersTest::testTdf125055` | `xlsx/pivottable_1s_difference.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2427` | `covered` | Project one-second-distinct pivot date/time members to visible PDF rows. |
| `ScPivotTableFiltersTest::testPivotTableXLSX_OutOfSyncPivotTableCachedDefinitionImport` | `xlsx/PivotTable_CachedDefinitionAndDataInSync.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2607` | `covered` | Project in-sync pivot cache/table import to visible PDF `K` and `Sum of A` values. |
| `ScPivotTableFiltersTest::testPivotTableXLSX_OutOfSyncPivotTableCachedDefinitionImport2` | `xlsx/PivotTable_CachedDefinitionAndDataNotInSync_SheetColumnsRemoved_WithCacheData.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2615` | `covered` | Project out-of-sync sheet data with cache data to visible PDF pivot values. |
| `ScPivotTableFiltersTest::testPivotTableXLSX_OutOfSyncPivotTableCachedDefinitionImport3` | `xlsx/PivotTable_CachedDefinitionAndDataNotInSync_SheetColumnsRemoved_WithoutCacheData.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2625` | `covered` | Project out-of-sync sheet data without cache data to visible PDF pivot values. |
| `ScPivotTableFiltersTest::testCalcFieldNameErrorXLSX` | `xlsx/pivot-table/pivot_calcfield_nameerror.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:3055` | `covered` | Project calculated-field name-error source workbook to visible PDF source rows and pivot totals. |
| `ScExportTest6::testTableStyleCustomRoundtripXLSX` | `xlsx/Book1_custom.xlsx` | `../core/sc/qa/unit/subsequent_export_test6.cxx:195` | `covered` | Project custom table style workbook to visible PDF headers, rows, and `Summary` total. |
| `ScExportTest2::testTdf165180_date1904_XLSX` | `xlsx/tdf165180_date1904.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1114` | `covered` | Project 1904 date-system handling to visible PDF date strings. |
| `ScExportTest2::testTdf122191` | `xlsx/tdf122191.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1341` | `covered` | Project localized boolean text import to visible PDF `IGAZ`, guarding against `BOOL00AN`. |
| `ScExportTest::testTdf169326_ignoreLineBreaksInReferencedCells` | `xlsx/tdf169326_ignore_line_breaks_in_referenced_cells.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:1841` | `covered` | Project referenced line-break formula display to visible PDF text. |
| `ScFiltersTest3::testtdf120301_xmlSpaceParsingXLSX` | `xlsx/tdf120301_xmlSpaceParsing.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:608` | `covered` | Project XML-space-preserved control labels to visible PDF form text. |
| `ScExportTest3::testFunctionsExcel2010XLSX` | `xlsx/functions-excel-2010.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:963` | `covered` | Project Excel 2010 function result table to visible PDF result/equality strings. |
| `ScExportTest3::testCeilingFloorXLSX` | `xlsx/ceiling-floor.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:994` | `covered` | Project CEILING/FLOOR formula check table to visible PDF values and errors. |
| `ScExportTest2::testTdf126024XLSX` | `xlsx/hyperlink_formula.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1553` | `covered` | Project hyperlink formula import to visible PDF link text. |
| `ScExportTest4::testTdf126177XLSX` | `xlsx/hyperlink_export.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:58` | `covered` | Project external workbook hyperlink location to visible PDF text. |
| `ScExportTest4::testTdf135828_Shape_Rect` | `xlsx/tdf135828_Shape_Rect.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:542` | `covered` | Project imported rectangle shape to visible PDF path output. |
| `ScExportTest4::testTdf137000_handle_upright` | `xlsx/tdf137000_export_upright.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:680` | `covered` | Project exported upright textbox body to visible PDF textbox text. |
| `ScFiltersTest3::testTextBoxBodyUpright` | `xlsx/tdf106197_import_upright.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1011` | `covered` | Project imported upright textbox body to visible PDF textbox text. |
| `ScFiltersTest3::testActiveXCheckboxXLSX` | `xlsx/activex_checkbox.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:522` | `covered` | Project ActiveX checkbox caption import to visible PDF text. |
| `ScFiltersTest4::testCellAnchoredHiddenShapesXLSX` | `xlsx/cell-anchored-hidden-shapes.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:381` | `covered` | Project hidden cell-anchored shape fixture to visible PDF sheet text while hidden shape paint remains absent. |
| `ScFiltersTest3::testShapeRotationImport` | `xlsx/testShapeRotationImport.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:949` | `covered` | Project rotated shape import to visible PDF rotated text segments. |
| `ScFiltersTest2::testTdf134455` | `xlsx/tdf134455.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1181` | `covered` | Project TIMEVALUE results over 59 minutes to visible PDF time strings. |
| `ScFiltersTest2::testTdf131424` | `xlsx/tdf131424.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1283` | `covered` | Project structured-reference formula sums to visible PDF table totals. |
| `ScFiltersTest5::testTdf122336` | `xlsx/tdf122336.xlsx` | `../core/sc/qa/unit/subsequent_filters_test5.cxx:111` | `covered` | Project imported date/job fields to visible PDF pages. |
| `ScExportTest3::shared-formula 3D reference assertions` | `xlsx/shared-formula/3d-reference.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:794` | `covered` | Project shared 3D reference cached results to visible PDF same-sheet and another-sheet value columns. |
| `ScFiltersTest4::testSharedFormulaXLSX` | `xlsx/shared-formula/basic.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1265` | `covered` | Project shared formula import to visible PDF formula value rows. |
| `ScExportTest3::testSharedFormulaStringResultExportXLSX` | `xlsx/shared-formula/text-results.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:815` | `covered` | Project shared formula string results to visible PDF cached same-sheet and another-sheet strings. |
| `ScFiltersTest2::testExternalRefCacheXLSX` | `xlsx/external-refs.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:632` | `covered` | Project external reference cache strings to visible PDF name rows. |
| `ScFiltersTest2::testRefStringXLSX` | `xlsx/ref_string.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:858` | `covered` | Project reference string formula result to visible PDF cached value. |
| `ScFiltersTest::testTdf139934` | `xlsx/tdf139934.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:274` | `covered` | Project imported date strings and absence-request rows to visible PDF pages. |
| `ScFiltersTest::testNonAsciiWithDotXLSX` | `xlsx/tdf100154.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:1636` | `covered` | Project non-ASCII sheet reference formula value to visible PDF pages. |
| `ScFiltersTest2::testTdf160371` | `xlsx/tdf160371.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:755` | `covered` | Project INDIRECT/intersection formula output to visible PDF value table. |
| `ScFiltersTest2::testTdf100709XLSX` | `xlsx/tdf100709.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1294` | `covered` | Project imported plain `218` values amid formatted values to visible PDF rows. |
| `ScExportTest2::testTdf105272` | `xlsx/tdf105272.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:996` | `covered` | Project structured-reference table formula result to visible PDF medal totals. |
| `ScFiltersTest::testTdf119292` | `xlsx/tdf119292.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:242` | `covered` | Project imported rotated text samples to visible PDF text strings. |
| `ScFiltersTest2::testTdf131536` | `xlsx/tdf131536.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1414` | `covered` | Project comparison formula display and referenced strings to visible PDF pages. |
| `ScExportTest2::testTdf137543XLSX` | `xlsx/tdf137543.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1596` | `covered` | Project LET function results to visible PDF source array and selected row outputs. |
| `ScExportTest2::testTdf170201_empty_values_in_array_formulas` | `xlsx/tdf170201.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1269` | `covered` | Project array formula non-empty values to visible PDF text while empty array elements stay blank. |
| `ScJumboSheetsTest::testTdf134553` | `xlsx/tdf134553.xlsx` | `../core/sc/qa/unit/jumbosheets-test.cxx:218` | `covered` | Project chart object import to visible PDF chart title and data labels. |
| `ScExportTest5::testTdf142929_filterLessThanXLSX` | `xlsx/tdf142929.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:62` | `covered` | Project less-than autofilter import to visible PDF filtered number rows. |
| `ScExportTest2::testAutofilterTop10XLSX` | `xlsx/tdf143068_top10filter.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:681` | `covered` | Project top-10 autofilter value to visible PDF top-four number rows. |
| `ScExportTest5::testExternalDefinedNameXLSX` | `xlsx/tdf144397.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:86` | `covered` | Project external defined-name formula results to visible PDF month strings and `#N/A`. |
| `ScExportTest::testTdf162963` | `xlsx/tdf162963_TableWithTotalsEnabled.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:1016` | `covered` | Project imported table totals-row state to visible PDF total row text. |
| `ScFiltersTest2::testAutofilterXLSX` | `xlsx/autofilter.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1018` | `covered` | Project imported autofilter area to visible PDF table rows. |
| `ScFiltersTest2::testNamedTableRef` | `xlsx/tablerefsnamed.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1661` | `covered` | Project named table-reference formulas to visible PDF `TRUE` result rows. |
| `ScFiltersTest::testDatabaseRangesXLSX` | `xlsx/database.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:938` | `covered` | Project database range import to visible PDF named/unnamed range result tables. |
| `ScExportTest2::testMatrixMultiplicationXLSX` | `xlsx/matrix-multiplication.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:157` | `covered` | Project matrix multiplication formula range to visible PDF array formula result values. |
| `ScExportTest2::testTdf118990` | `xlsx/tdf118990.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1010` | `covered` | Project external VLOOKUP formulas to visible PDF cached result values. |
| `ScExportTest5::testTdf163554` | `xlsx/tdf163554.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:1029` | `covered` | Project quoted 3D range formula result to visible PDF sheet values. |
| `ScFiltersTest2::testTdf85617` | `xlsx/tdf85617.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1454` | `covered` | Project sheet-local name formula result to visible PDF price value. |
| `ScFiltersTest5::testTdf118668` | `xlsx/tdf118668.xlsx` | `../core/sc/qa/unit/subsequent_filters_test5.cxx:120` | `covered` | Project visible second sheet import to printed multi-page PDF output. |
| `ScPivotTableFiltersTest::testPivotTableOutlineModeXLSX` | `xlsx/pivottable_outline_mode.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2143` | `covered` | Project outline-mode pivot layout to visible PDF pivot labels and total. |
| `ScPivotTableFiltersTest::testPivotTableTabularModeXLSX` | `xlsx/pivottable_tabular_mode.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2174` | `covered` | Project tabular-mode pivot layout to visible PDF row labels and total. |
| `ScPivotTableFiltersTest::testTdf124810_pivotDark` | `xlsx/pivot_dark1.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2359` | `covered` | Project pivot style/table output to visible PDF pivot text. |
| `ScPivotTableFiltersTest::testInvalidFormats` | `xlsx/pivottable_invalid_formats.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2985` | `covered` | Project pivot source with invalid format records to visible PDF formatted source rows. |
| `ScPivotTableFiltersTest::testPivotTableExportXLSX` | `xlsx/tdf89139_pivot_table.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:562` | `covered` | Project pivot item import, including hidden members, to visible PDF source and pivot totals. |
| `ScExportTest5::testTdf165503` | `xlsx/tdf165503.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:1140` | `covered` | Project chart numeric date cache source values to visible PDF date/value rows and chart output. |
| `ScFiltersTest3::testTdf137091` | `xlsx/tdf137091.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:708` | `covered` | Project Turkish-locale formula import result to visible PDF `28/4` output. |
| `ScFiltersTest3::testTdf70455` | `xlsx/tdf70455.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:753` | `covered` | Project bet-history formula result to visible PDF gross return `€780.00`. |
| `ScFiltersTest3::testTdf98481` | `xlsx/tdf98481.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:827` | `covered` | Project cross-sheet SUMIF/SUM formula results to visible PDF sum rows. |
| `ScFiltersTest3::testTdf115022` | `xlsx/tdf115022.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:844` | `covered` | Project recalculated aggregate value to visible PDF sum output. |
| `ScFiltersTest3::testTdf164895` | `xlsx/tdf164895.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1715` | `covered` | Project horizontal range operator formula result to visible PDF `30` output. |
| `ScFiltersTest4::testTdf162093` | `xlsx/tdf162093.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:147` | `covered` | Project structured-reference formula outputs to visible PDF table and formula-text pages. |
| `ScFiltersTest4::testTdf147955` | `xlsx/tdf147955.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1101` | `covered` | Project imported profit/loss formula values to visible PDF totals. |
| `ScFiltersTest4::testTdf155046` | `xlsx/tdf155046.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1352` | `covered` | Project boolean formula result to visible PDF survey rows. |
| `ScFiltersTest2::testTdf136364` | `xlsx/tdf136364.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1055` | `covered` | Project union formula results to visible PDF numeric output. |
| `ScFiltersTest5::testTdf157689` | `xlsx/tdf157689.xlsx` | `../core/sc/qa/unit/subsequent_filters_test5.cxx:44` | `covered` | Project imported autofilter ranges across sheets to visible PDF filtered rows. |
| `ScFiltersTest4::testTdf142905` | `xlsx/tdf142905.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1688` | `covered` | Project space-preserved text import to visible PDF text spacing. |
| `ScFiltersTest3::testTdf119190` | `xlsx/tdf119190.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1246` | `covered` | Project visible note caption import to visible PDF comment text. |
| `ScFiltersTest3::testTdf141495` | `xlsx/tdf141495.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:729` | `covered` | Project Turkish-locale date serial formula result to visible PDF serial values. |
| `ScExportTest2::testTdf79972XLSX` | `xlsx/tdf79972.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1535` | `covered` | Project external Bugzilla hyperlink to visible PDF text and link annotation target. |
| `ScExportTest::testTdf111876` | `xlsx/tdf111876.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:216` | `covered` | Project relative path hyperlink to visible PDF link text. |
| `ScExportTest5::testTdf119565` | `xlsx/tdf119565.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:892` | `covered` | Project themed textbox shape import to visible PDF textbox text while line-style paint remains covered by implementation work. |
| `ScExportTest3::testSheetCharacterKerningSpaceXLSX` | `xlsx/textbox-CharKerningSpace.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1467` | `covered` | Project textbox character-spacing fixture to visible PDF textbox text. |
| `ScExportTest3::testSheetCondensedCharacterSpaceXLSX` | `xlsx/textbox-CondensedCharacterSpace.xlsx` | `../core/sc/qa/unit/subsequent_export_test3.cxx:1485` | `covered` | Project condensed textbox character-spacing fixture to visible PDF textbox text. |
| `ScFiltersTest3::testTextBoxBodyRotateAngle` | `xlsx/tdf141644.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1052` | `covered` | Project imported textbox body rotation/writing mode to visible PDF rotated text. |
| `ScExportTest2::testTdf142881` | `xlsx/tdf142881.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1367` | `covered` | Project rotated and positioned drawing shapes to visible PDF rotated labels. |
| `ScExportTest2::testTdf145057` | `xlsx/tdf145057.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:985` | `covered` | Project color-filter table fixture to visible PDF filtered row. |
| `ScExportTest2::testTdf161365` | `xlsx/tdf161365.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1397` | `covered` | Project checkbox/control anchor fixture to visible PDF sheet text while control paint remains implementation coverage. |
| `ScExportTest2::testTdf115192XLSX` | `xlsx/test_115192.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:1182` | `covered` | Project drawing hyperlink relationships to visible PDF hyperlink labels. |
| `ScPivotTableFiltersTest::many-fields-in-cache import check` | `xlsx/pivot-table/many-fields-in-cache.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:989` | `covered` | Project multi-field pivot cache import to visible PDF source rows and pivot totals. |
| `ScPivotTableFiltersTest::testPivotTableDuplicatedMemberFilterXLSX` | `xlsx/pivottable_duplicated_member_filter.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2161` | `covered` | Project duplicated-member page-field filter import to visible PDF pivot totals. |
| `ScFiltersTest3::testTdf104310_x14` | `xlsx/tdf104310.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1736` | `covered` | Project x14 validation-list values to visible PDF sheet values. |
| `ScFiltersTest3::testTextLengthDataValidityXLSX` | `xlsx/textLengthDataValidity.xlsx` | `../core/sc/qa/unit/subsequent_filters_test3.cxx:1071` | `covered` | Project text-length data-validity fixture values to visible PDF number strings. |
| `ScExportTest2::testTdf120168` | `xlsx/tdf120168.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:371` | `covered` | Project horizontal alignment style import to visible PDF text placement samples. |
| `ScExportTest2::testTdf129985` | `xlsx/tdf129985.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:469` | `covered` | Project custom date number format import to visible PDF date strings. |
| `ScExportTest2::testTdf73063` | `xlsx/tdf73063.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:480` | `covered` | Project localized long-date number format to visible PDF date text. |
| `ScExportTest::testExtCondFormatXLSX` | `xlsx/tdf139021.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:157` | `covered` | Project extended conditional-format text-condition fixture to visible PDF sample strings. |
| `ScExportTest::testTdf139394` | `xlsx/tdf139394.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:132` | `covered` | Project extended conditional-format marker fixture to visible PDF plus/minus marker text. |
| `ScExportTest2::testTdf55417` | `xlsx/tdf55417.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:458` | `covered` | Project style alignment fixture to visible PDF sample value. |
| `ScExportTest::testTdf139167` | `xlsx/tdf139167.xlsx` | `../core/sc/qa/unit/subsequent_export_test.cxx:96` | `covered` | Project conditional style fixture to visible PDF sample text. |
| `ScJumboSheetsTest::testTdf109061` | `xlsx/tdf109061.xlsx` | `../core/sc/qa/unit/jumbosheets-test.cxx:312` | `covered` | Project recalculated jumbo-sheet sum value to visible PDF output. |
| `ScPivotTableFiltersTest::testTdf112106` | `xlsx/tdf112106.xlsx` | `../core/sc/qa/unit/pivottable_filters_test.cxx:2213` | `covered` | Project pivot data-layout import to visible PDF pivot totals and source rows. |
| `ScFiltersTest4::testTdf155402` | `xlsx/tdf155402.xlsx` | `../core/sc/qa/unit/subsequent_filters_test4.cxx:1675` | `covered` | Project `CELL(\"FILENAME\")` workbook path result to visible PDF text. |
| `ScExportTest4::testTdf91251_missingOverflowRoundtrip` | `xlsx/tdf91251_missingOverflowRoundtrip.xlsx` | `../core/sc/qa/unit/subsequent_export_test4.cxx:657` | `covered` | Project textbox overflow fixture to visible PDF textbox text. |
| `ScExportTest5::testTdf164417` | `xlsx/tdf164417.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:1114` | `covered` | Project mixed date/text autofilter ordering to visible PDF filtered rows. |
| `ScExportTest5::testTdf165886` | `xlsx/tdf165886.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:1186` | `covered` | Project formula quote parsing fixture to visible PDF formula result/error cells. |
| `ScExportTest5::testTdf166413` | `xlsx/tdf166413.xlsx` | `../core/sc/qa/unit/subsequent_export_test5.cxx:1218` | `covered` | Project conditional-format formula quote fixture to visible PDF text samples. |
| `ScExportTest2::testTdf95640_xlsx_to_xlsx` | `xlsx/tdf95640.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:523` | `covered` | Project standard filter list import to visible PDF filtered rows. |
| `ScFiltersTest2::testTdf97598XLSX` | `xlsx/tdf97598_scenarios.xlsx` | `../core/sc/qa/unit/subsequent_filters_test2.cxx:1305` | `covered` | Project scenario fixture first-cell text to visible PDF output. |
| `ScExportTest2::testEscapeCharInNumberFormatXLSX` | `xlsx/tdf81939.xlsx` | `../core/sc/qa/unit/subsequent_export_test2.cxx:716` | `covered` | Project escaped custom number formats to visible PDF formatted strings. |
| `CondFormatTest::testTdf155321_CondFormatColor_XLSX` | `xlsx/tdf155321.xlsx` | `../core/sc/qa/unit/cond_format.cxx:873` | `covered` | Project conditional color-scale fixture values to visible PDF cell text while color paint remains covered separately. |
| `CondFormatTest::testTdf156028_ColorScale_XLSX` | `xlsx/tdf156028.xlsx` | `../core/sc/qa/unit/cond_format.cxx:884` | `covered` | Project imported color-scale fixture value to visible PDF cell text. |
| `CondFormatTest::testTdf138601_CondFormatXLSX` | `xlsx/tdf138601.xlsx` | `../core/sc/qa/unit/cond_format.cxx:895` | `covered` | Project conditional-format value fixture to visible PDF numeric table. |
| `CondFormatTest::testCondFormatOperatorsSameRangeXLSX` | `xlsx/tdf139928.xlsx` | `../core/sc/qa/unit/cond_format.cxx:921` | `covered` | Project extended conditional operator fixture to visible PDF sample text. |
| `CondFormatTest::tdf169379` | `xlsx/tdf169379.xlsx` | `../core/sc/qa/unit/cond_format.cxx:1186` | `covered` | Project non-deduplicated conditional-format columns to visible PDF value columns. |
| `ScFiltersTest::testContentXLSXStrict` | `xlsx/universal-content-strict.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:190` | `covered` | Project strict OOXML universal content import to visible PDF core values. |
| `ScFiltersTest::testRowIndex1BasedXLSX` | `xlsx/row-index-1-based.xlsx` | `../core/sc/qa/unit/subsequent_filters_test.cxx:1609` | `covered` | Project row-index import fix to visible PDF first-row headers and multiline text. |
| `PivotTable_FieldsAndItemsExport::Pivot1_Row` | `xlsx/pivot/Pivot1_Row.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:161` | `covered` | Project single row-field pivot items to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot1_Row_Grand` | `xlsx/pivot/Pivot1_Row_Grand.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:210` | `covered` | Project single row-field grand total to visible PDF pivot total. |
| `PivotTable_FieldsAndItemsExport::Pivot1_Row_Grand_Subtotals` | `xlsx/pivot/Pivot1_Row_Grand_Subtotals.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:270` | `covered` | Project row-field item subtotals and grand total to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row` | `xlsx/pivot/Pivot2_Row.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:349` | `covered` | Project nested row-field pivot items to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row_Compact` | `xlsx/pivot/Pivot2_Row_Compact.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:591` | `covered` | Project compact row-field pivot layout to visible PDF row labels. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row_Grand` | `xlsx/pivot/Pivot2_Row_Grand.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:398` | `covered` | Project nested row-field grand total to visible PDF pivot total. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row_Grand_Subtotals` | `xlsx/pivot/Pivot2_Row_Grand_Subtotals.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:521` | `covered` | Project nested row-field subtotals and grand total to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row_Subtotals` | `xlsx/pivot/Pivot2_Row_Subtotals.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:455` | `covered` | Project nested row-field subtotals without grand total to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot2_Row_Subtotals_SortDescendingAll` | `xlsx/pivot/Pivot2_Row_Subtotals_SortDescendingAll.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:653` | `covered` | Project descending sorted row-field subtotals to visible PDF pivot rows. |
| `PivotTable_FieldsAndItemsExport::Pivot3_Column_Grand_Subtotals` | `xlsx/pivot/Pivot3_Column_Grand_Subtotals.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:719` | `covered` | Project column-field subtotals and grand total to visible PDF pivot values. |
| `PivotTable_FieldsAndItemsExport::Pivot4_Column_Grand_Subtotals_SortDescending` | `xlsx/pivot/Pivot4_Column_Grand_Subtotals_SortDescending.xlsx` | `../core/sc/qa/unit/PivotTable_FieldsAndItemsExport.cxx:787` | `covered` | Project descending sorted column-field subtotals to visible PDF pivot values. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_1_DataFieldInRow_RowLabelColor` | `xlsx/pivot-table/PivotTableCellFormatsTest_1_DataFieldInRow_RowLabelColor.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:101` | `covered` | Project pivot format selection fixture to visible PDF data-field-in-row values. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_4_DataFieldInColumn_DataColor` | `xlsx/pivot-table/PivotTableCellFormatsTest_4_DataFieldInColumn_DataColor.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:165` | `covered` | Project pivot format selection fixture to visible PDF data-field-in-column totals. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_8_DataFieldInRow_DataColor` | `xlsx/pivot-table/PivotTableCellFormatsTest_8_DataFieldInRow_DataColor.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:250` | `covered` | Project pivot format selection fixture to visible PDF row data values. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_9_MultipleSelections` | `xlsx/pivot-table/PivotTableCellFormatsTest_9_MultipleSelections.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:266` | `covered` | Project multiple pivot format selections to visible PDF pivot totals. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_11_WholeDataColumnSelected` | `xlsx/pivot-table/PivotTableCellFormatsTest_11_WholeDataColumnSelected.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:314` | `covered` | Project whole data-column pivot format selection to visible PDF pivot totals. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_12_WholeLabelColumnSelected` | `xlsx/pivot-table/PivotTableCellFormatsTest_12_WholeLabelColumnSelected.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:340` | `covered` | Project whole label-column pivot format selection to visible PDF pivot totals. |
| `ScPivotTableFormatsImportExport::PivotTableCellFormatsTest_13_SelectionInLabelAndData` | `xlsx/pivot-table/PivotTableCellFormatsTest_13_SelectionInLabelAndData.xlsx` | `../core/sc/qa/unit/PivotTableFormatsImportExport.cxx:362` | `covered` | Project combined label/data pivot format selection to visible PDF pivot values. |
| `CondFormatTest::testColorScaleNumWithRefXLSX` | `xlsx/colorscale_num_with_ref.xlsx` | `../core/sc/qa/unit/cond_format.cxx:345` | `covered` | Project color-scale reference fixture to visible PDF numeric grid values. |
| `CondFormatTest::testCondFormatImportCellIs` | `xlsx/condFormat_cellis.xlsx` | `../core/sc/qa/unit/cond_format.cxx:453` | `covered` | Project cell-is conditional-format fixture to visible PDF values across both sheets. |
| `CondFormatTest::testCondFormatThemeColorXLSX` | `xlsx/condformat_theme_color.xlsx` | `../core/sc/qa/unit/cond_format.cxx:484` | `covered` | Project theme-color databar fixture to visible PDF signed and sequential values. |
| `CondFormatTest::testCondFormatParentXLSX` | `xlsx/cond_parent.xlsx` | `../core/sc/qa/unit/cond_format.cxx:566` | `covered` | Project inherited conditional-format style fixture to visible PDF sample text. |
| `CondFormatTest::testTdf162948` | `xlsx/tdf162948.xlsx` | `../core/sc/qa/unit/cond_format.cxx:698` | `covered` | Project custom icon-set conditional-format fixture to visible PDF paired values. |
| `CondFormatTest::testConditionalFormatExportXLSX` | `xlsx/new_cond_format_test_export.xlsx` | `../core/sc/qa/unit/cond_format.cxx:798` | `covered` | Project exported conditional-format rule sample workbook to visible PDF rule tables. |
| `CondFormatTest::testCondFormatFormulaIsXLSX` | `xlsx/tdf113013.xlsx` | `../core/sc/qa/unit/cond_format.cxx:952` | `covered` | Project formula-is conditional-format fixture to visible PDF boolean-value grids. |
| `CondFormatTest::testCondFormatBeginsAndEndsWithXLSX` | `xlsx/tdf120749.xlsx` | `../core/sc/qa/unit/cond_format.cxx:973` | `covered` | Project begins-with/ends-with conditional-format fixture to visible PDF sample strings. |
| `CondFormatTest::testExtCondFormatXLSX` | `xlsx/tdf122102.xlsx` | `../core/sc/qa/unit/cond_format.cxx:1006` | `covered` | Project extended contains-text conditional-format fixture to visible PDF sample strings. |
| `CondFormatTest::testConditionalFormatPriorityCheckXLSX` | `xlsx/conditional_fmt_checkpriority.xlsx` | `../core/sc/qa/unit/cond_format.cxx:1109` | `covered` | Project conditional-format priority fixture to visible PDF sample strings across sheets. |
| `CondFormatTest::testConditionalFormatOriginXLSX` | `xlsx/conditional_fmt_origin.xlsx` | `../core/sc/qa/unit/cond_format.cxx:1156` | `covered` | Project conditional-format origin fixture to visible PDF repeated sample strings. |
| `CondFormatTest::testTdf170298_importHang` | `xlsx/tdf170298.xlsx` | `../core/sc/qa/unit/cond_format.cxx:285` | `covered` | Project large conditional-format workbook import fixture to visible PDF investment sheet text. |
