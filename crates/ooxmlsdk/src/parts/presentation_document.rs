...
impl PresentationDocument {
  pub const MAIN_PART_RELATIONSHIP_TYPE: &'static str = <crate::parts::presentation_part::PresentationPart as crate::sdk::SdkPartHandle>::RELATIONSHIP_TYPE;
  pub fn presentation_part(
    &self,
  ) -> Result<crate::parts::presentation_part::PresentationPart, crate::common::SdkError> {
    self.main_part_id
            .map(
            ...
            .ok_or_else(|| {
                crate::common::SdkError::CommonError(
                    concat!("missing main part for ", stringify!(PresentationDocument))
                        .to_string(),
                )
            })
  }
...
impl PresentationDocument {
  ...
  fn part_ref_from_relationship(
    ...
    if crate::common::relationship_type_matches(
      ...
      return Some(
                crate::parts::PartRef::PresentationPart(
                    <crate::parts::presentation_part::PresentationPart as crate::sdk::SdkPartHandle>::from_part_id(
                        part_id,
                    ),
                ),
