pub fn simple_type_mapping(name: &str) -> &str {
  match name {
    ...
    "a:ST_Coordinate" => "CoordinateValue",
    "a:ST_Coordinate32" => "Coordinate32Value",
    "a:ST_PositiveCoordinate" => "PositiveCoordinateValue",
    "a:ST_PositiveCoordinate32" => "PositiveCoordinate32Value",
    "a:ST_Percentage" => "DrawingmlPercentageValue",
    "a:ST_PositivePercentage" => "PositiveDrawingmlPercentageValue",
    "ask:ST_LineSketchSeed" => "UInt32Value",
    "b:ST_String255" => "StringValue",
    "cppr:ST_PublishDate" => "StringValue",
    "ST_ContentType" => "StringValue",
    "ST_Extension" => "StringValue",
    ...
    "a:ST_Angle" => "DrawingmlAngleValue",
    "a:ST_DrawingElementId" => "UInt32Value",
    "a:ST_FixedPercentage" => "FixedPercentageValue",
    "a:ST_PositiveFixedPercentage" => "PositiveFixedPercentageValue",
    "a:ST_TextBulletSize" => "TextBulletSizeValue",
    "a:ST_TextBulletSizeDecimal" => "TextBulletSizeValue",
    "a:ST_TextBulletSizePercent" => "TextBulletSizeValue",
    "a:ST_TextFontScalePercentOrPercentString" => "TextFontScalePercentOrPercentStringValue",
    "a:ST_TextFontSize" => "TextFontSizeValue",
    "a:ST_TextPoint" => "TextPointValue",
    "a:ST_TextSpacingPercentOrPercentString" => "TextSpacingPercentOrPercentStringValue",
    "a:ST_TextSpacingPoint" => "TextSpacingPointValue",
    "msink:ST_Point" => "StringValue",
    "w:ST_DecimalNumber" => "Int32Value",
    "w:ST_HexColorRGB" => "HexBinaryValue",
    "w:ST_HpsMeasure_O12" => "HpsMeasureValue",
    "w:ST_NonNegativeDecimalNumber" => "Int32Value",
    "w:ST_SignedDecimalNumberMax-1" => "Int32Value",
    "w:ST_SignedDecimalNumberMax-2" => "Int32Value",
    "w:ST_SignedHpsMeasure_O12" => "SignedHpsMeasureValue",
    "w:ST_SignedTwipsMeasure_O12" => "SignedTwipsMeasureValue",
    "w:ST_StylePaneSortMethods_O12" => "HexBinaryValue",
    "w:ST_TwipsMeasure_O12" => "TwipsMeasureValue",
    "w:ST_UnsignedDecimalNumber" => "UInt32Value",
    "w:ST_UnsignedDecimalNumberMin1" => "Int32Value",
    "w:ST_DecimalNumberOrPercent" => "DecimalNumberOrPercentValue",
    "w:ST_MeasurementOrPercent" => "MeasurementOrPercentValue",
    "s:ST_TwipsMeasure" => "TwipsMeasureValue",
    "s:ST_UniversalMeasure" => "UniversalMeasureValue",
    "s:ST_PositiveUniversalMeasure" => "PositiveUniversalMeasureValue",
