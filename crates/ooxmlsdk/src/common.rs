...
pub(crate) use xml::{
  ...
  write_decimal_number_or_percent_value, write_escaped_bytes, write_escaped_content_bytes,
  write_escaped_content_str, write_escaped_content_text, write_escaped_str, write_escaped_text,
  write_f32_value, write_f64_value, write_i8_value, write_i16_value, write_i32_value,
  write_i64_value, write_list_content_str_value, write_list_str_value, write_list_value,
