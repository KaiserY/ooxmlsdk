...
impl WordprocessingDocument {
  pub const MAIN_PART_RELATIONSHIP_TYPE: &'static str = <crate::parts::main_document_part::MainDocumentPart as crate::sdk::SdkPartHandle>::RELATIONSHIP_TYPE;
  pub fn main_document_part(
    &self,
  ) -> Result<crate::parts::main_document_part::MainDocumentPart, crate::common::SdkError> {
    self.main_part_id
            .map(
            ...
            .ok_or_else(|| {
                crate::common::SdkError::CommonError(
                    concat!("missing main part for ", stringify!(WordprocessingDocument))
                        .to_string(),
                )
            })
  }
...
impl WordprocessingDocument {
  ...
  fn part_ref_from_relationship(
    ...
    if crate::common::relationship_type_matches(
      ...
      return Some(
                crate::parts::PartRef::MainDocumentPart(
                    <crate::parts::main_document_part::MainDocumentPart as crate::sdk::SdkPartHandle>::from_part_id(
                        part_id,
                    ),
                ),
