...
pub(crate) fn uri_by_prefix(prefix: &str) -> Option<&'static str> {
  match prefix {
    ...
    "cx1" => Some("http://schemas.microsoft.com/office/drawing/2015/9/8/chartex"),
    "cx2" => Some("http://schemas.microsoft.com/office/drawing/2015/10/21/chartex"),
    "cx3" => Some("http://schemas.microsoft.com/office/drawing/2016/5/9/chartex"),
    "cx4" => Some("http://schemas.microsoft.com/office/drawing/2016/5/10/chartex"),
    "cx5" => Some("http://schemas.microsoft.com/office/drawing/2016/5/11/chartex"),
    "cx6" => Some("http://schemas.microsoft.com/office/drawing/2016/5/12/chartex"),
    "cx7" => Some("http://schemas.microsoft.com/office/drawing/2016/5/13/chartex"),
    "cx8" => Some("http://schemas.microsoft.com/office/drawing/2016/5/14/chartex"),
    "wpi" => Some("http://schemas.microsoft.com/office/word/2010/wordprocessingInk"),
    "w16" => Some("http://schemas.microsoft.com/office/word/2018/wordml"),
    "ve" => Some("http://schemas.openxmlformats.org/markup-compatibility/2006"),
    "hs" => Some("http://schemas.haansoft.com/office/spreadsheet/8.0"),
    _ => None,
  }
}
pub(crate) fn variant_by_prefix(prefix: &str) -> Option<&'static str> {
  match prefix {
    ...
    "dgm" => Some("Dgm"),
    "dgm14" => Some("Dgm14"),
    "dgm1611" => Some("Dgm1611"),
    "dgm1612" => Some("Dgm1612"),
    "ds" => Some("Ds"),
    "dsp" => Some("Dsp"),
    "emma" => Some("Emma"),
    "inkml" => Some("Inkml"),
    ...
    "w16cur" => Some("W16cur"),
    "w16du" => Some("W16du"),
    "w16sdtdh" => Some("W16sdtdh"),
    "w16sdtfl" => Some("W16sdtfl"),
    "w16se" => Some("W16se"),
    "we" => Some("We"),
    "wetp" => Some("Wetp"),
    "wne" => Some("Wne"),
    ...
    "xlecs" => Some("Xlecs"),
    "xlecs2" => Some("Xlecs2"),
    "xlmsforms" => Some("Xlmsforms"),
    "xlpar" => Some("Xlpar"),
    "xlpcalc" => Some("Xlpcalc"),
    "xlpda" => Some("Xlpda"),
    "xlpds" => Some("Xlpds"),
    "xlrd" => Some("Xlrd"),
    "xlrd2" => Some("Xlrd2"),
...
pub(crate) fn minimum_version_by_prefix(prefix: &str) -> Option<&'static str> {
  match prefix {
    ...
    "a15" => Some("Office2013"),
    "a16" => Some("Office2016"),
    "a1611" => Some("Office2019"),
    "a3danim" => Some("Office2019"),
    "aanim" => Some("Office2019"),
    "aclsh" => Some("Office2021"),
    "adec" => Some("Office2019"),
    "ahyp" => Some("Office2019"),
    "aif" => Some("Microsoft365"),
    "aink" => Some("Office2019"),
    "alf" => Some("Office2021"),
    "am3d" => Some("Office2019"),
    "aoe" => Some("Microsoft365"),
    "ask" => Some("Office2021"),
    "asl" => Some("Microsoft365"),
    "asvg" => Some("Office2019"),
    "c14" => Some("Office2010"),
    "c15" => Some("Office2013"),
    "c16" => Some("Office2016"),
    "c16ac" => Some("Office2016"),
    "c16r3" => Some("Office2019"),
    "cdr14" => Some("Office2010"),
    "clbl" => Some("Office2021"),
    "com14" => Some("Office2010"),
    "cr" => Some("Microsoft365"),
    "cs" => Some("Office2013"),
    "cx" => Some("Office2016"),
    "dgm14" => Some("Office2010"),
    "dgm1611" => Some("Office2019"),
    "dgm1612" => Some("Office2019"),
    "dsp" => Some("Office2010"),
    "md" => Some("Office2013"),
    "mso14" => Some("Office2010"),
    "oac" => Some("Office2016"),
    "oel" => Some("Office2021"),
    "p14" => Some("Office2010"),
    "p15" => Some("Office2013"),
    "p16" => Some("Office2016"),
    "p1710" => Some("Office2019"),
    "p173" => Some("Office2019"),
    "p184" => Some("Office2019"),
    "p188" => Some("Office2021"),
    "p1912" => Some("Office2021"),
    "p202" => Some("Office2021"),
    "p216" => Some("Microsoft365"),
    "p223" => Some("Microsoft365"),
    "p228" => Some("Microsoft365"),
    "p232" => Some("Microsoft365"),
    "pRoam" => Some("Office2013"),
    "pav" => Some("Office2010"),
    "pc" => Some("Office2016"),
    "pc2" => Some("Microsoft365"),
    "pc226" => Some("Microsoft365"),
    "pic14" => Some("Office2010"),
    "pj15" => Some("Office2013"),
    "sle" => Some("Office2010"),
    "t" => Some("Office2021"),
    "thm15" => Some("Office2013"),
    "tsle" => Some("Office2013"),
    "w14" => Some("Office2010"),
    "w15" => Some("Office2013"),
    "w16cex" => Some("Office2021"),
    "w16cid" => Some("Office2019"),
    "w16cur" => Some("Office2021"),
    "w16du" => Some("Microsoft365"),
    "w16sdtdh" => Some("Office2021"),
    "w16sdtfl" => Some("Microsoft365"),
    "w16se" => Some("Office2016"),
    "we" => Some("Office2013"),
    "wetp" => Some("Office2013"),
    "woe" => Some("Microsoft365"),
    "wp14" => Some("Office2010"),
    "wp15" => Some("Office2013"),
    "wpc" => Some("Office2010"),
    "wpg" => Some("Office2010"),
    "wps" => Some("Office2010"),
    "x12ac" => Some("Office2013"),
    "x14" => Some("Office2010"),
    "x14ac" => Some("Office2010"),
    "x15" => Some("Office2013"),
    "x15ac" => Some("Office2013"),
    "x16" => Some("Office2016"),
    "x16r2" => Some("Office2016"),
    "x16r3" => Some("Office2021"),
    "xcalcf" => Some("Office2019"),
    "xda" => Some("Office2019"),
    "xdr14" => Some("Office2010"),
    "xfpb" => Some("Microsoft365"),
    "xlPr" => Some("Office2019"),
    "xlecs" => Some("Microsoft365"),
    "xlecs2" => Some("Microsoft365"),
    "xlmsforms" => Some("Microsoft365"),
    "xlpar" => Some("Microsoft365"),
    "xlpcalc" => Some("Microsoft365"),
    "xlpda" => Some("Microsoft365"),
    "xlpds" => Some("Microsoft365"),
    "xlrd" => Some("Office2019"),
    "xlrd2" => Some("Office2019"),
    "xlrdwi" => Some("Office2021"),
    "xlrvr" => Some("Office2021"),
    "xlrvrel" => Some("Microsoft365"),
    "xltc" => Some("Office2019"),
    "xltc2" => Some("Office2021"),
    "xlwcv" => Some("Microsoft365"),
    "xnsv" => Some("Office2021"),
    "xpdl" => Some("Office2019"),
    "xprd" => Some("Microsoft365"),
    "xr" => Some("Office2016"),
    "xr10" => Some("Office2019"),
    "xr16" => Some("Office2019"),
    "xr2" => Some("Office2019"),
    "xr3" => Some("Office2019"),
    "xr5" => Some("Office2019"),
    "xr6" => Some("Office2019"),
    "xr9" => Some("Office2019"),
    "xxdsv" => Some("Microsoft365"),
    "xxl21" => Some("Microsoft365"),
    "xxlnp" => Some("Office2021"),
    "xxpim" => Some("Office2021"),
    "xxpvi" => Some("Microsoft365"),
    "xsi" => Some("Office2007"),
    "cx1" => Some("Office2016"),
    "cx2" => Some("Office2016"),
    "cx3" => Some("Office2016"),
