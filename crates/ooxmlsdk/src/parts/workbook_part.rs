...
pub struct WorkbookPart {
  ...
  pub(crate) calculation_chain_part:
    crate::sdk::PartChild<crate::parts::calculation_chain_part::CalculationChainPart>,
  #[sdk(part_child(
  ...
  pub(crate) cell_metadata_part:
    crate::sdk::PartChild<crate::parts::cell_metadata_part::CellMetadataPart>,
  #[sdk(part_child(
  ...
  pub(crate) connections_part:
    crate::sdk::PartChild<crate::parts::connections_part::ConnectionsPart>,
  #[sdk(part_child(
  ...
  pub(crate) custom_xml_mappings_part:
    crate::sdk::PartChild<crate::parts::custom_xml_mappings_part::CustomXmlMappingsPart>,
  #[sdk(part_child(
  ...
  pub(crate) shared_string_table_part:
    crate::sdk::PartChild<crate::parts::shared_string_table_part::SharedStringTablePart>,
  #[sdk(part_child(
  ...
  pub(crate) workbook_revision_header_part:
    crate::sdk::PartChild<crate::parts::workbook_revision_header_part::WorkbookRevisionHeaderPart>,
  #[sdk(part_child(
  ...
  pub(crate) workbook_user_data_part:
    crate::sdk::PartChild<crate::parts::workbook_user_data_part::WorkbookUserDataPart>,
  #[sdk(part_child(
    relationship_type = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles",
    kind = "optional"
  ))]
  pub(crate) workbook_styles_part:
    crate::sdk::PartChild<crate::parts::workbook_styles_part::WorkbookStylesPart>,
  #[sdk(part_child(
  ...
  pub(crate) volatile_dependencies_part:
    crate::sdk::PartChild<crate::parts::volatile_dependencies_part::VolatileDependenciesPart>,
  #[sdk(part_child(
    relationship_type = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chartsheet",
    kind = "repeated"
  ))]
  pub(crate) chartsheet_parts: crate::sdk::PartChild<crate::parts::chartsheet_part::ChartsheetPart>,
  #[sdk(part_child(
  ...
  pub(crate) dialogsheet_parts:
    crate::sdk::PartChild<crate::parts::dialogsheet_part::DialogsheetPart>,
  #[sdk(part_child(
  ...
  pub(crate) external_workbook_parts:
    crate::sdk::PartChild<crate::parts::external_workbook_part::ExternalWorkbookPart>,
  #[sdk(part_child(
    relationship_type = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/pivotCacheDefinition",
    kind = "repeated"
  ))]
  pub(crate) pivot_table_cache_definition_parts: crate::sdk::PartChild<
  ...
  pub(crate) excel_attached_toolbars_part:
    crate::sdk::PartChild<crate::parts::excel_attached_toolbars_part::ExcelAttachedToolbarsPart>,
  #[sdk(part_child(
  ...
  pub(crate) macro_sheet_parts:
    crate::sdk::PartChild<crate::parts::macro_sheet_part::MacroSheetPart>,
  #[sdk(part_child(
    relationship_type = "http://schemas.microsoft.com/office/2006/relationships/xlIntlMacrosheet",
    kind = "repeated"
  ))]
  pub(crate) international_macro_sheet_parts: crate::sdk::PartChild<
  ...
  pub(crate) custom_data_properties_parts:
    crate::sdk::PartChild<crate::parts::custom_data_properties_part::CustomDataPropertiesPart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) slicer_cache_parts:
    crate::sdk::PartChild<crate::parts::slicer_cache_part::SlicerCachePart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) time_line_cache_parts:
    crate::sdk::PartChild<crate::parts::time_line_cache_part::TimeLineCachePart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) workbook_person_parts:
    crate::sdk::PartChild<crate::parts::workbook_person_part::WorkbookPersonPart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) rd_rich_value_parts:
    crate::sdk::PartChild<crate::parts::rd_rich_value_part::RdRichValuePart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) ct_rd_rich_value_structure_parts:
    crate::sdk::PartChild<crate::parts::rd_rich_value_structure_part::RdRichValueStructurePart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
    relationship_type = "http://schemas.microsoft.com/office/2017/06/relationships/rdArray",
    kind = "repeated"
  ))]
  pub(crate) rd_array_parts: crate::sdk::PartChild<crate::parts::rd_array_part::RdArrayPart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) rich_styles_parts:
    crate::sdk::PartChild<crate::parts::rich_styles_part::RichStylesPart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
    relationship_type = "http://schemas.microsoft.com/office/2017/06/relationships/rdSupportingPropertyBag",
    kind = "repeated"
  ))]
  pub(crate) rd_supporting_property_bag_parts: crate::sdk::PartChild<
  ...
  pub(crate) rd_supporting_property_bag_structure_parts: crate::sdk::PartChild<
  ...
  pub(crate) rd_rich_value_types_parts:
    crate::sdk::PartChild<crate::parts::rd_rich_value_types_part::RdRichValueTypesPart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) rd_rich_value_web_image_part:
    crate::sdk::PartChild<crate::parts::rd_rich_value_web_image_part::RdRichValueWebImagePart>,
  #[cfg(feature = "microsoft365")]
  #[sdk(part_child(
  ...
  pub(crate) feature_property_bags_part:
    crate::sdk::PartChild<crate::parts::feature_property_bags_part::FeaturePropertyBagsPart>,
}
