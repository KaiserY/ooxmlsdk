...
| `CondFormatTest::testColorScaleXLSX` | `xlsx/colorscale.xlsx` | `../core/sc/qa/unit/cond_format.cxx:603` | `review` | Source checks imported color-scale model entries. Promote only with PDF fill/raster assertions for the rendered scale colors. |
| `CondFormatTest::testDataBarXLSX` | `xlsx/databar.xlsx` | `../core/sc/qa/unit/cond_format.cxx:585` | `review` | Source checks imported data-bar model entries. Promote only with PDF bar geometry/fill-color assertions. |
...
| `CondFormatTest::testComplexIconSetsXLSX` | `xlsx/complex_icon_set.xlsx` | `../core/sc/qa/unit/cond_format.cxx:676` | `review` | Source checks icon-set model entries and selected icon indexes. Promote only with rendered icon/path/raster assertions. |
...
| `CondFormatTest::testTdf167019` | `xlsx/tdf167019.xlsx` | `../core/sc/qa/unit/cond_format.cxx:271` | `review` | Source checks conditional-format rule ranges and formulas. Promote only with rendered formatting assertions for affected cells. |
...
| `SparklineImportExportTest::testSparklinesRoundtripXLSX` | `xlsx/Sparklines.xlsx` | `../core/sc/qa/unit/SparklineImportExportTest.cxx:149` | `review` | Source checks sparkline model import/roundtrip. Promote only with PDF sparkline path/raster assertions, not plain source cell values. |
...
| `ScFiltersTest5::testTotalRowToggle` | `xlsx/TableStyleTest.xlsx` | `../core/sc/qa/unit/subsequent_filters_test5.cxx:332` | `covered` | Project the fixture's initial imported table and totals row to visible PDF table text. |
...
| `CondFormatTest::testTdf155321_CondFormatColor_XLSX` | `xlsx/tdf155321.xlsx` | `../core/sc/qa/unit/cond_format.cxx:873` | `review` | Source checks color-scale result color. Promote only with a PDF cell-fill/raster color assertion for the affected cell. |
| `CondFormatTest::testTdf156028_ColorScale_XLSX` | `xlsx/tdf156028.xlsx` | `../core/sc/qa/unit/cond_format.cxx:884` | `review` | Source checks color-scale result color. Promote only with a PDF cell-fill/raster color assertion for the affected cell. |
| `CondFormatTest::testTdf138601_CondFormatXLSX` | `xlsx/tdf138601.xlsx` | `../core/sc/qa/unit/cond_format.cxx:895` | `review` | Source checks color-scale entry colors. Promote only with PDF rendered color assertions, not plain cell values. |
| `CondFormatTest::testCondFormatOperatorsSameRangeXLSX` | `xlsx/tdf139928.xlsx` | `../core/sc/qa/unit/cond_format.cxx:921` | `review` | Source checks conditional-format operators in the same range. Promote only with rendered style/color differences for matching cells. |
| `CondFormatTest::tdf169379` | `xlsx/tdf169379.xlsx` | `../core/sc/qa/unit/cond_format.cxx:1186` | `review` | Source checks non-deduplicated conditional-format keys. Promote only with PDF-visible formatting differences by column. |
