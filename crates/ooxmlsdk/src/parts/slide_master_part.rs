...
pub struct SlideMasterPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::SlideMaster,
    ...
    pub slide_layout_parts: Vec<crate::parts::slide_layout_part::SlideLayoutPart>,
