pub fn simple_type_mapping(name: &str) -> &str {
  match name {
    ...
    "a:ST_Percentage" => "DecimalNumberOrPercentValue",
    "a:ST_PositivePercentage" => "DecimalNumberOrPercentValue",
    ...
    "a:ST_FixedPercentage" => "DecimalNumberOrPercentValue",
    "a:ST_PositiveFixedPercentage" => "DecimalNumberOrPercentValue",
    "a:ST_TextFontScalePercentOrPercentString" => "DecimalNumberOrPercentValue",
    "a:ST_TextSpacingPercentOrPercentString" => "DecimalNumberOrPercentValue",
