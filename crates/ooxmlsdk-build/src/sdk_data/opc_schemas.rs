...
use crate::sdk_data::sdk_data_model::{
  ...
  SchemaTypeAttributeValidator, SchemaTypeChild, SchemaTypeCompositeKind, SchemaTypeFixedAttribute,
...
fn core_property_text_type(child: &ParsedChildElement) -> SchemaType {
  let fixed_attributes = match child.q_name.as_str() {
    "dcterms:created" | "dcterms:modified" => vec![SchemaTypeFixedAttribute {
