...
pub struct GradientFillProperties {
  ...
  #[sdk(
        choice(
            ...
            child(variant = PathShadeProperties, boxed, qname = "w14:path")
        )
    )]
...
pub struct TextOutlineEffect {
  ...
  #[sdk(
        choice(
            ...
            child(variant = SolidColorFillProperties, boxed, qname = "w14:solidFill"),
            child(variant = GradientFillProperties, boxed, qname = "w14:gradFill")
        )
    )]
