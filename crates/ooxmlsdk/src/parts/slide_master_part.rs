...
impl SlideMasterPart {
  crate::sdk_part_root_methods!(
    ...
    SlideMasterPart,
    as_slide_master_part,
    as_slide_master_part_mut
  );
  ...
  pub fn slide_layout_parts_relationships<'a, P: crate::sdk::SdkPackage>(
    &'a self,
    package: &'a P,
  ) -> impl Iterator<Item = crate::common::RelationshipRef<'a>> + 'a {
    <Self as crate::sdk::SdkPart>::child_relationships_by_type(
  ...
  pub fn slide_layout_parts<'a, P: crate::sdk::SdkPackage>(
    &'a self,
    package: &'a P,
  ) -> impl Iterator<Item = crate::parts::slide_layout_part::SlideLayoutPart> + 'a {
    <Self as crate::sdk::SdkPart>::child_parts_by_relationship_type::<
      P,
      crate::parts::slide_layout_part::SlideLayoutPart,
    >(
