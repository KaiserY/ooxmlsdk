...
pub(crate) fn uri_by_prefix(prefix: &str) -> Option<&'static str> {
    match prefix {
        ...
        #[cfg(feature = "microsoft365")]
        "a3danim" => {
            Some("http://schemas.microsoft.com/office/drawing/2018/animation/model3d")
        }
        #[cfg(feature = "microsoft365")]
        "aanim" => Some("http://schemas.microsoft.com/office/drawing/2018/animation"),
        "ac" => {
            Some("http://schemas.openxmlformats.org/officeDocument/2006/characteristics")
        }
        #[cfg(feature = "microsoft365")]
        "aclsh" => {
            Some("http://schemas.microsoft.com/office/drawing/2020/classificationShape")
        }
        #[cfg(feature = "microsoft365")]
        ...
        #[cfg(feature = "microsoft365")]
        "pRoam" => {
            Some("http://schemas.microsoft.com/office/powerpoint/2012/roamingSettings")
        }
        "packaging" => {
            Some("http://schemas.microsoft.com/office/internal/2007/ofapi/packaging")
        }
        #[cfg(feature = "microsoft365")]
        ...
        #[cfg(feature = "microsoft365")]
        "pc2" => {
            Some("http://schemas.microsoft.com/office/powerpoint/2019/9/main/command")
        }
        #[cfg(feature = "microsoft365")]
        "pc226" => {
            Some("http://schemas.microsoft.com/office/powerpoint/2022/06/main/command")
        }
        ...
        "vt" => {
            Some("http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes")
        }
        ...
        #[cfg(feature = "microsoft365")]
        "w16sdtdh" => {
            Some("http://schemas.microsoft.com/office/word/2020/wordml/sdtdatahash")
        }
        #[cfg(feature = "microsoft365")]
        "w16sdtfl" => {
            Some("http://schemas.microsoft.com/office/word/2024/wordml/sdtformatlock")
        }
        #[cfg(feature = "microsoft365")]
        ...
        #[cfg(feature = "microsoft365")]
        "wetp" => {
            Some("http://schemas.microsoft.com/office/webextensions/taskpanes/2010/11")
        }
        ...
        #[cfg(feature = "microsoft365")]
        "wp14" => {
            Some("http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing")
        }
        #[cfg(feature = "microsoft365")]
        "wp15" => {
            Some("http://schemas.microsoft.com/office/word/2012/wordprocessingDrawing")
        }
        #[cfg(feature = "microsoft365")]
        "wpc" => {
            Some("http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas")
        }
        #[cfg(feature = "microsoft365")]
        "wpg" => {
        ...
        #[cfg(feature = "microsoft365")]
        "xcalcf" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2018/calcfeatures")
        }
        #[cfg(feature = "microsoft365")]
        "xda" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2017/dynamicarray")
        }
        "xdr" => {
        ...
        #[cfg(feature = "microsoft365")]
        "xdr14" => {
            Some("http://schemas.microsoft.com/office/excel/2010/spreadsheetDrawing")
        }
        #[cfg(feature = "microsoft365")]
        "xfpb" => {
            Some(
        ...
        #[cfg(feature = "microsoft365")]
        "xlmsforms" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2023/msForms")
        }
        #[cfg(feature = "microsoft365")]
        "xlpar" => {
            Some(
        ...
        #[cfg(feature = "microsoft365")]
        "xlrd2" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2017/richdata2")
        }
        #[cfg(feature = "microsoft365")]
        "xlrdwi" => {
            Some(
        ...
        #[cfg(feature = "microsoft365")]
        "xlrvrel" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2022/richvaluerel")
        }
        #[cfg(feature = "microsoft365")]
        "xltc" => {
            Some(
        ...
        #[cfg(feature = "microsoft365")]
        "xprd" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2022/pivotRichData")
        }
        #[cfg(feature = "microsoft365")]
        "xr" => Some("http://schemas.microsoft.com/office/spreadsheetml/2014/revision"),
        #[cfg(feature = "microsoft365")]
        "xr10" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2016/revision10")
        }
        #[cfg(feature = "microsoft365")]
        "xr16" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2017/revision16")
        }
        #[cfg(feature = "microsoft365")]
        ...
        #[cfg(feature = "microsoft365")]
        "xxl21" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2021/extlinks2021")
        }
        #[cfg(feature = "microsoft365")]
        "xxlnp" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2019/extlinksprops")
        }
        #[cfg(feature = "microsoft365")]
        "xxpim" => {
            Some("http://schemas.microsoft.com/office/spreadsheetml/2020/pivotNov2020")
        }
        #[cfg(feature = "microsoft365")]
        "xxpvi" => {
            Some(
