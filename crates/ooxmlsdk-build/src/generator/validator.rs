...
pub fn gen_validators_neo(schema: &OpenXmlSchema, gen_context: &GenContextNeo) -> TokenStream {
  ...
  for t in &schema.types {
    ...
    for attr in &t.attributes {
      attr_validator_stmt_list.extend(gen_attr_validator_stmt_list_neo(
        attr,
        schema_namespace,
        gen_context,
      ));
