...
/// Defines the PercentageWidth Class.
pub type PercentageWidth = crate::simple_type::PositiveDrawingmlPercentageValue;
/// Defines the PercentageHeight Class.
pub type PercentageHeight = crate::simple_type::PositiveDrawingmlPercentageValue;
