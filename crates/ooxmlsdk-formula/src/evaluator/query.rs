...
fn criteria_error_value(value: &str) -> Option<FormulaErrorValue> {
  match value.trim().to_ascii_uppercase().as_str() {
    ...
    "#ERROR!" => Some(FormulaErrorValue::Error),
    "#N/IMPL!" => Some(FormulaErrorValue::NotImplemented),
    "#CIRC!" => Some(FormulaErrorValue::CircularReference),
    "ERR:501" => Some(FormulaErrorValue::IllegalChar),
    "ERR:502" => Some(FormulaErrorValue::IllegalArgument),
    "ERR:504" => Some(FormulaErrorValue::IllegalParameter),
    "ERR:507" => Some(FormulaErrorValue::Pair),
    "ERR:508" => Some(FormulaErrorValue::PairExpected),
    "ERR:509" => Some(FormulaErrorValue::OperatorExpected),
    "ERR:510" => Some(FormulaErrorValue::VariableExpected),
    "ERR:511" => Some(FormulaErrorValue::Parameter),
    "ERR:512" => Some(FormulaErrorValue::CodeOverflow),
    "ERR:513" => Some(FormulaErrorValue::StringOverflow),
    "ERR:514" => Some(FormulaErrorValue::StackOverflow),
    "ERR:515" => Some(FormulaErrorValue::Error),
    "ERR:516" => Some(FormulaErrorValue::InvalidVariable),
    "ERR:517" => Some(FormulaErrorValue::InvalidOpcode),
    "ERR:518" => Some(FormulaErrorValue::InvalidStackValue),
    "ERR:520" => Some(FormulaErrorValue::InvalidToken),
    "ERR:522" => Some(FormulaErrorValue::CircularReference),
    "ERR:523" => Some(FormulaErrorValue::NoConvergence),
    "ERR:530" => Some(FormulaErrorValue::NoAddin),
    "ERR:531" => Some(FormulaErrorValue::NoMacro),
    "ERR:533" => Some(FormulaErrorValue::NestedArray),
    "ERR:538" => Some(FormulaErrorValue::MatrixSize),
    "ERR:539" => Some(FormulaErrorValue::BadArrayContent),
    "ERR:540" => Some(FormulaErrorValue::LinkFormulaNeedingCheck),
    _ => None,
  }
}
...
fn formula_error_criteria_code(value: FormulaErrorValue) -> i32 {
  match value {
    ...
    FormulaErrorValue::Error => i32::MAX,
    FormulaErrorValue::NotImplemented => i32::MAX,
    FormulaErrorValue::CircularReference => 522,
    FormulaErrorValue::IllegalChar => 501,
    FormulaErrorValue::IllegalArgument => 502,
    FormulaErrorValue::IllegalParameter => 504,
    FormulaErrorValue::Pair => 507,
    FormulaErrorValue::PairExpected => 508,
    FormulaErrorValue::OperatorExpected => 509,
    FormulaErrorValue::VariableExpected => 510,
    FormulaErrorValue::Parameter => 511,
    FormulaErrorValue::CodeOverflow => 512,
    FormulaErrorValue::StringOverflow => 513,
    FormulaErrorValue::StackOverflow => 514,
    FormulaErrorValue::InvalidVariable => 516,
    FormulaErrorValue::InvalidOpcode => 517,
    FormulaErrorValue::InvalidStackValue => 518,
    FormulaErrorValue::InvalidToken => 520,
    FormulaErrorValue::NoConvergence => 523,
    FormulaErrorValue::NoAddin => 530,
    FormulaErrorValue::NoMacro => 531,
    FormulaErrorValue::NestedArray => 533,
    FormulaErrorValue::MatrixSize => 538,
    FormulaErrorValue::BadArrayContent => 539,
    FormulaErrorValue::LinkFormulaNeedingCheck => 540,
  }
}
